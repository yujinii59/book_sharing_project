...
<body>
<form action="jikwonadmit" method="post">
<table style="text-align: center; width: 80%; margin:auto;" class="newbooktable"> 
 <tr><th>id</th><th>이름</th><th>직급</th><th>승인</th></tr>
  <c:forEach var="n" items="${newa }">
	<tr>
		<td>
			${n.admin_id }
			<input type = "hidden" name = "admin_id" value="${n.admin_id }">		
		</td>
		<td>${n.admin_name}</td>
		<td>${n.admin_jik }</td>
		<td>
			<select name = "admin_acc">
