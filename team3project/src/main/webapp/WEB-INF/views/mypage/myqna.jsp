...
<div id="s_left" align="center">
	<table  style="width: 80%; float: none; margin: auto; text-align: center;">
		<tr>
...
<div id="contents">
	<table class="buymaintable" style="width: 80%; float: none; margin: auto; text-align: center;">
		<tr>
			<td style="width: 60%;" rowspan="5"><br> <br>
			 <c:choose>
					<c:when test="${f:length(inqlist) eq 0}">
						1:1 문의내역이 존재하지 않습니다. <br>
					</c:when>
					<c:otherwise>
						<table class="buymaintable" style="width: 80%; float: none; margin: auto; text-align: center;">

							<tr>
								<td colspan="4" style="background-color: #114c3d; color: white; text-align: center;">
								나의 QnA 질의 내역</td>
							</tr>
							<tr>
								<th>문의 번호</th>
